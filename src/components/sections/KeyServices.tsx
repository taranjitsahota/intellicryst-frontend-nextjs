...
const KeyServices: React.FC = () => {
  return (
    <div className="relative max-w-[1800px] mx-auto px-8 md:px-16 lg:px-24 py-16 overflow-hidden">
      ...
      <div className="text-center mb-16 space-y-4">
        <h4 className="text-[var(--deep-blue)] font-black text-xs uppercase tracking-[0.4em]">Core Capabilities</h4>
          ...
          <div className="flex-1 relative flex items-center justify-center min-h-[180px] z-10">
            <div className="relative">
              <div className="w-24 h-24 bg-white rounded-3xl flex items-center justify-center border border-slate-100 shadow-sm relative z-10">
                <Cloud size={40} className="text-[var(--primary-blue)]" />
              </div>
              <div className="absolute top-[-50px] left-[-60px] w-14 h-14 glass rounded-2xl flex items-center justify-center shadow-md animate-bounce" style={{ animationDuration: '3s' }}>
                <span className="text-[11px] font-black text-[var(--deep-blue)]">AWS</span>
              </div>
              <div className="absolute top-[-10px] right-[-70px] w-14 h-14 glass rounded-2xl flex items-center justify-center shadow-md animate-bounce" style={{ animationDuration: '4s', animationDelay: '0.5s' }}>
                <span className="text-[11px] font-black text-[var(--deep-blue)]">AZURE</span>
              </div>
              <div className="absolute bottom-[20px] left-[-70px] w-14 h-14 glass rounded-2xl flex items-center justify-center shadow-md animate-bounce" style={{ animationDuration: '3.5s', animationDelay: '0.2s' }}>
                <span className="text-[11px] font-black text-[var(--deep-blue)]">GCP</span>
              </div>
              <div className="absolute bottom-[-20px] right-[-50px] w-14 h-14 glass rounded-2xl flex items-center justify-center shadow-md animate-bounce" style={{ animationDuration: '4.5s', animationDelay: '1s' }}>
                <span className="text-[11px] font-black text-[var(--deep-blue)]">NEXUS</span>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="bg-white/70 rounded-[32px] border border-white overflow-hidden shadow-sm h-full flex flex-col backdrop-blur-md">
              ...
              <div className="p-6 space-y-5">
                ...
                <div className="pt-4 flex flex-col gap-2">
                   ...
                   <div className="h-2 w-full bg-slate-200 rounded-full overflow-hidden">
                      <div className="h-full w-[80%] bg-[var(--deep-blue)]"></div>
                   </div>
                </div>
              </div>
            </div>
        ...
        <div className="md:col-span-6 lg:col-span-4 bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden flex flex-col group hover:shadow-2xl transition-all duration-500 relative">
          ...
          <div className="flex-1 relative flex items-center justify-center min-h-[160px] z-10">
            <div className="relative">
              ...
              <div className="w-56 h-36 bg-gradient-to-br from-blue-600 to-[var(--deep-blue)] rounded-3xl shadow-2xl p-6 flex flex-col justify-between group-hover:-translate-y-3 transition-transform duration-700">
