...
const Industries: React.FC = () => {
  return (
    <div className="w-full max-w-[1440px] mx-auto px-6 md:px-10 lg:px-16 py-12 md:py-14 lg:py-16 ">
      ...
      <div className="bg-[var(--deep-blue)] rounded-[48px] min-h-[240px] lg:min-h-[280px] relative overflow-hidden flex flex-col justify-center p-6 lg:p-8 group">
        ...
        <div className="absolute inset-0 pointer-events-none select-none overflow-hidden">
          ...
          <svg
            className="absolute right-[-5%] top-[-10%] w-[70%] h-[120%] opacity-80"
          ...
          >
            <g filter="url(#glowRibbon)">
              <path
                d="M800 1000C600 800 400 600 500 300C600 0 800 100 800 100"
                stroke="#00F5D4"
                strokeWidth="1"
                strokeOpacity="0.2"
              />
              <path
                d="M850 1000C650 750 350 550 450 250C550 -50 850 50 850 50"
                stroke="white"
                strokeWidth="40"
                strokeOpacity="0.05"
              />
              ...
              <path
                d="M900 1000C700 700 300 500 400 200C500 -100 900 0 900 0"
