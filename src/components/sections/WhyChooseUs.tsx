...
const WhyChooseUs: React.FC = () => {
  ...
  return (
    <div className="max-w-[1440px] mx-auto px-[32px] md:px-[64px] lg:px-[96px] py-16 relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
        ...
        <div className="relative animate-in slide-in-from-left duration-1000">
          <div className="rounded-[64px] overflow-hidden shadow-2xl relative">
            ...
            />
            <div className="absolute inset-0 bg-gradient-to-t from-[var(--deep-blue)]/40 to-transparent"></div>
          </div>
        ...
        <div className="space-y-16 animate-in slide-in-from-right duration-1000">
          <div className="space-y-8">
            <h4 className="text-[var(--deep-blue)] font-black text-xs uppercase tracking-[0.4em]">Work With The Best</h4>
