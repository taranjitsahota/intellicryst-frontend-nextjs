             ...
             <form className="space-y-8" onSubmit={e => e.preventDefault()}>
                ...
                <div className="space-y-3">
                  ...
                  <div className="relative">
                    <select className="w-full px-5 py-3 rounded-2xl bg-white/60 border border-white focus:border-[#00F5D4] focus:bg-white transition-all outline-none appearance-none font-semibold text-[#012B48] shadow-sm">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                   <button className="flex-1 bg-[#012B48] text-white py-3.5 rounded-2xl font-black text-sm uppercase tracking-[0.2em] hover:bg-[#00F5D4] hover:text-[#012B48] transition-all flex items-center justify-center gap-3 group shadow-2xl shadow-navy/30">
                      Start Project <Send size={18} className="group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform" />
                   </button>
                   <button className="px-10 py-3.5 border-2 border-[#012B48] text-[#012B48] rounded-2xl font-black text-sm uppercase tracking-[0.2em] hover:bg-white/80 transition-all">
                      Talk To Us
                   </button>
                </div>
             </form>
